...
class MaterialSymbolsIconSet extends DeviceIconSet {
  ...
  IconData icon(DeviceType type) => switch (type) {
        ...
        DeviceType.co2Sensor        => Symbols.air,
        DeviceType.freezeSensor     => Symbols.ac_unit,
        DeviceType.tamperSensor     => Symbols.warning,
        DeviceType.mailboxSensor    => Symbols.mail,
  ...
  Color color(DeviceType type) => switch (type) {
        ...
        DeviceType.co2Sensor        => AppColors.motionColor,
        DeviceType.freezeSensor     => AppColors.acColor,
        DeviceType.tamperSensor     => AppColors.statusAlarm,
        DeviceType.mailboxSensor    => AppColors.doorColor,
