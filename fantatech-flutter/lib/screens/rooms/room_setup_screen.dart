...
final _blind    = _Cap(Symbols.blinds,           Color(0xFF8E63CE), 'מפסק תריס', 'Blind Switch', _Dest.sensors, {DeviceType.blind}, null, DeviceIcons.photoAsset(DeviceType.blind));
...
final _intercom = _Cap(Symbols.doorbell,         Color(0xFFEF5350), 'אינטרקום', 'Intercom', _Dest.intercom, {DeviceType.intercom}, null, DeviceIcons.photoAsset(DeviceType.intercom));
