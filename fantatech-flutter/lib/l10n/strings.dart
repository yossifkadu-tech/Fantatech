...
class S {
  ...
  final String co2Detector;
  final String freezeDetector;
  final String tamperDetector;
  final String mailboxDetector;
  ...
  const S({
    ...
    required this.co2Detector,
    required this.freezeDetector,
    required this.tamperDetector,
    required this.mailboxDetector,
  ...
  static const S _he = S(
    ...
    doorSensor: 'דלת כניסה', windowsSensor: 'חלונות', motionSensors: 'חיישני תנועה', smokeDetector: 'גלאי עשן', waterLeakSensor: 'גלאי נזילה', gasDetector: 'גלאי גז', co2Detector: 'גלאי CO2', freezeDetector: 'גלאי הקפאה', tamperDetector: 'גלאי מניפולציה', mailboxDetector: 'גלאי תיבת דואר',
  ...
  static const S _en = S(
    ...
    doorSensor: 'Front Door', windowsSensor: 'Windows', motionSensors: 'Motion Sensors', smokeDetector: 'Smoke Detector', waterLeakSensor: 'Water Leak Sensor', gasDetector: 'Gas Detector', co2Detector: 'CO2 Detector', freezeDetector: 'Freeze Sensor', tamperDetector: 'Tamper Sensor', mailboxDetector: 'Mailbox Sensor',
  ...
  static const S _ar = S(
    ...
    doorSensor: 'باب الدخول', windowsSensor: 'النوافذ', motionSensors: 'كاشف الحركة', smokeDetector: 'كاشف الدخان', waterLeakSensor: 'كاشف تسرب الماء', gasDetector: 'كاشف الغاز', co2Detector: 'كاشف CO2', freezeDetector: 'كاشف التجمد', tamperDetector: 'كاشف العبث', mailboxDetector: 'كاشف صندوق البريد',
  ...
  static const S _am = S(
    ...
    doorSensor: 'የፊት ደጃፍ', windowsSensor: 'መስኮቶች', motionSensors: 'እንቅስቃሴ ዳሳሽ', smokeDetector: 'ጭስ ዳሳሽ', waterLeakSensor: 'የውሃ መፍሰስ ዳሳሽ', gasDetector: 'ጋዝ ዳሳሽ', co2Detector: 'CO2 ዳሳሽ', freezeDetector: 'የመቀዝቀዝ ዳሳሽ', tamperDetector: 'የመንካካት ዳሳሽ', mailboxDetector: 'የፖስታ ሳጥን ዳሳሽ',
  ...
  static const S _es = S(
    ...
    doorSensor: 'Puerta principal', windowsSensor: 'Ventanas', motionSensors: 'Sensores de movimiento', smokeDetector: 'Detector de humo', waterLeakSensor: 'Sensor de fuga de agua', gasDetector: 'Detector de gas', co2Detector: 'Detector de CO2', freezeDetector: 'Sensor de congelación', tamperDetector: 'Sensor de manipulación', mailboxDetector: 'Sensor de buzón',
  ...
  static const S _ru = S(
    ...
    doorSensor: 'Входная дверь', windowsSensor: 'Окна', motionSensors: 'Датчики движения', smokeDetector: 'Датчик дыма', waterLeakSensor: 'Датчик протечки воды', gasDetector: 'Датчик газа', co2Detector: 'Датчик CO2', freezeDetector: 'Датчик замерзания', tamperDetector: 'Датчик вскрытия', mailboxDetector: 'Датчик почтового ящика',
  ...
  static const S _fr = S(
    ...
    doorSensor: 'Porte d\'entrée', windowsSensor: 'Fenêtres', motionSensors: 'Détecteurs de mouvement', smokeDetector: 'Détecteur de fumée', waterLeakSensor: 'Détecteur de fuite d\'eau', gasDetector: 'Détecteur de gaz', co2Detector: 'Détecteur de CO2', freezeDetector: 'Détecteur de gel', tamperDetector: 'Détecteur d\'intrusion', mailboxDetector: 'Détecteur de boîte aux lettres',
